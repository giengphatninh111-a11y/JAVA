    ...
    public String orders(@RequestParam(required = false) String keyword,
        ...
        if (keyword != null && !keyword.isEmpty()) {
            orders = orders.stream()
                    .filter(o -> (o.getUser() != null && o.getUser().getFullName().toLowerCase().contains(keyword.toLowerCase()))
                            || (o.getPhone() != null && o.getPhone().contains(keyword)))
                    .toList();
        }
        ...
        if (paymentStatus != null && !paymentStatus.isEmpty()) {
            Order.PaymentStatus ps = Order.PaymentStatus.valueOf(paymentStatus);
            orders = orders.stream()
                    .filter(o -> o.getPaymentStatus() == ps)
                    .toList();
        }
