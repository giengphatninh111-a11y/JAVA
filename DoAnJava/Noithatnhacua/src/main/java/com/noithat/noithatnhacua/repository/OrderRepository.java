...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT MONTH(o.createdAt), SUM(o.totalPrice) FROM Order o WHERE YEAR(o.createdAt) = YEAR(CURRENT_DATE) AND o.paymentStatus = 'PAID' GROUP BY MONTH(o.createdAt) ORDER BY MONTH(o.createdAt)")
