...
-- Dumping data for table noithat_db.categories: ~8 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `status` enum('PENDING','CONFIRMED','SHIPPING','DELIVERED','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `cancelled_by_user` tinyint(1) NOT NULL DEFAULT '0',
  `payment_method` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COD',
...
INSERT INTO `orders` (`id`, `user_id`, `total_price`, `address`, `phone`, `status`, `created_at`, `cancelled_by_user`, `payment_method`, `payment_status`) VALUES
	(1, 2, 6799000.00, '106/2A', '0784467113', 'DELIVERED', '2026-06-06 16:57:29', 0, 'COD', 'UNPAID'),
	(2, 2, 399000.00, '106/2a', '0784467113', 'CONFIRMED', '2026-06-06 16:58:30', 0, 'COD', 'PAID'),
	(3, 2, 699000.00, '106/2a', '0748867113', 'CANCELLED', '2026-06-06 16:58:50', 0, 'COD', 'UNPAID'),
	(4, 2, 999000.00, '106/2a', '0784467113', 'PENDING', '2026-06-06 17:00:22', 0, 'COD', 'UNPAID');
...
-- Dumping data for table noithat_db.products: ~0 rows (approximately)
INSERT INTO `products` (`id`, `name`, `description`, `price`, `stock`, `image_url`, `is_active`, `category_id`) VALUES
	...
	(29, 'Tủ Bếp Vincoplast Cao Cấp Trắng 03', '', 1290000.00, 1, 'https://noithatthanhnhan.net/thumbb/500x500/2/upload/sanpham/f5df722a260cd4528d1d-16186246435.jpg', 1, 10),
...
-- Dumping data for table noithat_db.users: ~3 rows (approximately)
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `phone`, `address`, `role`, `created_at`) VALUES
	...
	(2, 'Giêng Phát Ninh', 'giengphatninh111@gmail.com', '123456', '', '', 'USER', '2026-06-06 16:56:58'),
	(3, 'Phùng Thanh Độ', 'mixi@gmail.com', '123456', '123789', '37d kênh tân hoá\r\n', 'USER', '2026-06-10 16:51:02');
